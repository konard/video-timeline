...
function getCurrentMarkers(totalDuration: number, stepMs: number, pixelsPerMs: number) {
  const markers: { position: number; time: number; label: string }[] = [];
...
function getFixedMarkers(totalDuration: number, stepMs: number, pixelsPerMs: number) {
  const markers: { position: number; time: number; label: string }[] = [];
